...
public class VragenlijstWerkEnGehoor {
    ...
    private final String d4v3_a = "Hoe vaak komt het voor dat u waarschuwingsgeluiden (telefoon, alarmbel, " +
            "infuuspomp, piep van een oven etc.) moet horen op uw werk?";
    private final String d4v3_b = "Kost het u inspanning en concentratie om waarschuwingsgeluiden te horen?";
    private final String d4v4_a = "Hoe vaak komt het voor dat u een gesprek in rumoer moet volgen op uw werk?";
    private final String d4v4_b = "Kost het volgen van een gesprek in rumoer u inspanning en concentratie?";
    private final String d4v5_a = "Bij een lawaaiige werkomgeving (omgeving met veel (machine) lawaai); heeft u " +
            "gehoorbeschermers tot uw beschikking?";
    private final String d4v5_a2 = "Indien ja, welk soort (bijv. kap, otoplastiek):";
    private final String d4v5_b = "Indien bij 5a. ja, kost het volgen van een gesprek i.c.m. gehoorbeschermers u " +
            "inspanning en concentratie (indien u in deze situatie gesprekken voert)?";
    private final String d4v6_a = "Hoe vaak komt het voor dat u een gesprek in een stille omgeving moet volgen op uw " +
            "werk?";
    private final String d4v6_b = "Kost het volgen van een gesprek in een stille omgeving u inspanning en " +
            "concentratie?";
    ...
    private final String d5v1j = "Zijn er op het werk wel eens dingen ernstig mis gegaan, omdat u iets niet (goed) " +
            "hoorde?";
    private final String d5v1j_2 = "Indien ‘ja’, kunt u beschrijven wat er mis ging?";
    private final String d5v1k = "Heeft u wel eens hulp gezocht voor coaching/ondersteuning bij uw slechthorendheid " +
            "op de werkvloer?";
    private final String d5v1k_2 = "Indien ‘ja’, wat voor hulp heeft u gehad?";
...
//        private final String d4v2a_o17 = "anders:";
                ...
                new OpenVraag(d4v2b),
                new MeerkeuzeVraag(d4v3_a, optiesFrequentie),
                new MeerkeuzeVraag(d4v3_b, optiesHoeveelheid1),
                new MeerkeuzeVraag(d4v4_a, optiesFrequentie),
                new MeerkeuzeVraag(d4v4_b, optiesHoeveelheid1),
...
//                "inspanning en concentratie (indien u in deze situatie gesprekken voert)?";
                ...
                new MeerkeuzeVraag(d4v6_a, optiesFrequentie),
                new MeerkeuzeVraag(d4v6_b, optiesHoeveelheid1),
//        private final String d4v7a = "De onderstaande vragen gaan over de complexe luistersituaties op uw werk die u " +
//                "veel luisterinspanning kosten en waar u graag iets aan zou willen doen om vermoeidheid tegen te gaan. " +
//                "Beschrijf deze situaties en geef aan hoeveel luisterinspanning dit in de huidige situatie kost:";
